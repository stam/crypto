...
const candleData = [
  ...
  { open: 1031580, close: 962644, low: 961699, high: 1043700, timespan: '1D', datetime: new Date('2018-03-07T00:00:00.000Z')},
  { open: 962500, close: 962912, low: 900002, high: 975756, timespan: '1D', datetime: new Date('2018-03-07T00:00:00.000Z')},
  { open: 961182, close: 901575, low: 900773, high: 977840, timespan: '1D', datetime: new Date('2018-03-07T00:00:00.000Z')},
  { open: 901618, close: 964205, low: 882721, high: 979625, timespan: '1D', datetime: new Date('2018-03-07T00:00:00.000Z')},
  { open: 964600, close: 933945, low: 901524, high: 999988, timespan: '1D', datetime: new Date('2018-03-07T00:00:00.000Z')},
  { open: 935230, close: 935627, low: 907508, high: 955300, timespan: '1D', datetime: new Date('2018-03-07T00:00:00.000Z')},
  { open: 937230, close: 860124, low: 850001, high: 951140, timespan: '1D', datetime: new Date('2018-03-07T00:00:00.000Z')},
];

export const candles = bulkCreate(Candle, candleData);
...
it('The TA lib supports rolling indicator calculations', () => {
  ...
  result = ta.nextValue(candleData[7].close);
...
describe('An indicator', () => {
  it('will calculate a result based on candles', async () => {
    ...
    emaIndicator.updateValue(candles[7]);
